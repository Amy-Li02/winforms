...
namespace System.Windows.Forms.Maui.IntegrationTests
{
    ...
    /// </summary>
    [Collection("Maui")]
    public class WinformsMauiDragDropEffectsTests
    {
        private const string ProjectName = "MauiDragDropEffectsTests";

        [Theory]
        [MauiData(ProjectName)]
        public void MauiDragDropEffectsTests(string scenarioName)
        {
